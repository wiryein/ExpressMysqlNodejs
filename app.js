...
app.use(session({ secret: 'wirye', cookie: { maxAge: 60000 }, resave:true, saveUninitialized:true}, ))
...
app.get('/', (req, res) => {
    ...
    res.render('index')  // ./views/index.ejs 실행해라뜻
})
...
app.get('/contactDelete', (req, res) => {
    ...
    connection.query(sql, function(err, result){
        if(err) throw err;
        console.log('자료삭제가 완료되었습니다.')
        res.send("<script> alert('삭제가 완료되었습니다'); location.href='/contactList'</script>")
    })
})
